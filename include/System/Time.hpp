#ifndef INCLUDED_SYSTEM_TIME_HPP
#define INCLUDED_SYSTEM_TIME_HPP
...
namespace System {
	...
	///
	////////////////////////////////////////////////////////////
	std::ostream& operator <<(std::ostream& os, System::Time const& _time);

}

#endif // INCLUDED_SYSTEM_TIME_HPP