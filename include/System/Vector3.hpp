#ifndef INCLUDED_SYSTEM_VECTOR_3_HPP_
#define INCLUDED_SYSTEM_VECTOR_3_HPP_
...
namespace System {
	...
	public:
		...
		///	\brief	Initialises x, y and z to the given values
		///
		///	\param	_vec	value that x and y are set to
		///
		///	\param	_z		value that z is set to
		///
		////////////////////////////////////////////////////////////
		Vector3(const Vector2<T>& _vec, T _z);
...
////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////
	template <typename T>
	std::ostream& operator <<(std::ostream& os, System::Vector3<T> const& _vec);
...
#endif // INCLUDED_SYSTEM_VECTOR_3_HPP_