...
namespace Driller {
	...
	JobElement ElementHelpers::createBuildElevatorJob(int _level) {
		auto job = JobElement(JobContextInfo(JobContextInfo::BuildElevatorJob(_level)), System::Vector2i(0, _level), System::Vector2f(0 * DrillerDefinitions::TileWidth, (_level - 1) * DrillerDefinitions::TileHeight));
	...
	JobElement ElementHelpers::createDigDirtJob(int _level, int _column) {
		auto job = JobElement(JobContextInfo(JobContextInfo::DigDirtJob(_column, _level)), System::Vector2i(_column, _level));
	...
	JobElement ElementHelpers::createBuildRoomJob(const JobContextInfo& _contextInfo) {
		...
		JobElement job = JobElement(_contextInfo, tilePosition, workPosition);
