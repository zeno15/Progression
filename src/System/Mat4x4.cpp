...
namespace System {
	...
	Mat4x4::Mat4x4(	float _0, float _4, float _8,  float _12,
	...
	Mat4x4 Mat4x4::createRotationX(float _angle) {
		...
		mat[5] = +cosf(TO_RADIANS(_angle));		mat[6] = -sinf(TO_RADIANS(_angle));
		mat[9] = +sinf(TO_RADIANS(_angle));		mat[10] = +cosf(TO_RADIANS(_angle));
	...
	Mat4x4 Mat4x4::createRotationY(float _angle) {
		...
		mat[0] = +cosf(TO_RADIANS(_angle));		mat[2] = +sinf(TO_RADIANS(_angle));
		mat[8] = -sinf(TO_RADIANS(_angle));		mat[10] = +cosf(TO_RADIANS(_angle));
	...
	Mat4x4 Mat4x4::createRotationZ(float _angle) {
		...
		mat[0] = +cosf(TO_RADIANS(_angle));		mat[1] = -sinf(TO_RADIANS(_angle));
		mat[4] = +sinf(TO_RADIANS(_angle));		mat[5] = +cosf(TO_RADIANS(_angle));
